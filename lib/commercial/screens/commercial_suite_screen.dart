            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  contentPadding: EdgeInsets.zero,
                  title: Text(
                    item['product_name'] as String? ?? 'Product $productId',
                  ),
...
class _CashReturnsPanelState extends State<_CashReturnsPanel> {
  ...
  Future<void> _open(BuildContext context) async {
    ...
    try {
      var registers = await widget.state.commercial.listCashRegisters(
        widget.user,
      );
      if (registers.isEmpty) {
        ...
        registers = await widget.state.commercial.listCashRegisters(
          widget.user,
        );
      }
      if (registers.isEmpty) {
