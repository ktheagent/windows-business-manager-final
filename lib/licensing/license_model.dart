class LicenseModel {
  ...
  factory LicenseModel.fromJson(Map<String, dynamic> json) {
    ...
    final status = _string(json, const [
      'status',
    ], fallback: 'invalid').toLowerCase();
    final businessName = _string(json, const ['businessName', 'business_name']);
    final customer = _string(json, const [
      'customer',
      'customerName',
      'customer_name',
    ], fallback: businessName);
    final expiryAt = _date(json, const [
      'expiryDate',
      'expiryAt',
      'expiry_at',
      'expiresAt',
    ...
    return LicenseModel(
      ...
      deviceLimit:
          ...
          1,
      activatedDevice: _string(json, const [
        'activatedDevice',
        'deviceIdentifier',
        'device_identifier',
      ]),
      offlineGraceDeadline: _date(json, const [
  ...
  LicenseModel copyWith({
    ...
    return LicenseModel(
      ...
      offlineGraceDeadline: offlineGraceDeadline ?? this.offlineGraceDeadline,
